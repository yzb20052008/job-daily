<template>
	<view class="content">
		...
		<view class="header">
			<view class="header-top">
				<view class="userinfo" @click="toLogin">
					...
					<view class="info" v-if="userInfo.token">
						<view class="name">
							...
							<text class="driver">求职</text>
							<text class="info-nav yzb yzb-next"></text>
						</view>
						<view class="other-info">
							<text class="phone" v-if="userInfo.phone">{{userInfo.phone | phone}}</text>
				...
				<view class="switch" @click="toSwitch">
					<text class="switch-name">我要招人</text>
		...
		<view class="body">
			<view class="w-list">
				<view class="grid">
					<view class="grid-item" v-for="(item, index) in gridList" :key="index" @click="gridClick(item)">
		...
		<u-popup :show="show" mode="center" round="20" bgColor="transparent">
			<view class="pop-content">
				<image :show-menu-by-longpress="true" src="/static/logo.png"></image>
			</view>
...
<script>
	...
	export default {
		...
		methods: {
			...mapMutations(['setUserInfo', 'setMemberRole']),
