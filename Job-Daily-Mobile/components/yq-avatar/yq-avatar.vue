<template name="yq-avatar">
	<view>
		<image :src="imgSrc.imgSrc" @click.stop="fSelect" :style="[ iS ]" class="my-avatar"></image>
		...
		<view class="oper-wrapper" :style="{display: sD, top:tp}">
			<view class="oper">
				<view class="btn-wrapper" v-if="sO">
					<view @click.stop="fSelect" hover-class="hover" :style="{width: bW}"><text>重选</text></view>
					<view @click.stop="fClose" hover-class="hover" :style="{width: bW}"><text>关闭</text></view>
					<view @click.stop="fRotate" hover-class="hover" :style="{width: bW, display: bD}"><text>旋转</text></view>
					<view @click.stop="fPreview" hover-class="hover" :style="{width: bW}"><text>预览</text></view>
					<view @click.stop="fUpload" hover-class="hover" :style="{width: bW}"><text>上传</text></view>
				</view>
				<view class="clr-wrapper" v-else>
					...
					<view @click.stop="fPrvUpload" hover-class="hover" :style="{width: bW}"><text>上传</text></view>
				</view>
			</view>
		</view>
	</view>
