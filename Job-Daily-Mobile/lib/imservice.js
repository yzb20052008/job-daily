...
IMService.prototype.connect = function(currentUser) {
	...
	if(this.currentUser.memberRole=='company'){
		this.currentUser.id=this.currentUser.id+"-com"
	}
	let userData = {
		name: this.currentUser.realname,
		avatar: this.currentUser.avatar
	}
	if(currentUser.memberRole=="planer"){
		userData.role="planer";
		userData.chatType="plan";
	}
	//初始化相关的监听器
