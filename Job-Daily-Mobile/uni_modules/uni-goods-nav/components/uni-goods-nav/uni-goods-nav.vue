		...
		<view class="uni-tab__cart-box flex">
			...
			<view :class="{'uni-tab__right':fill}" class="flex uni-tab__cart-sub-right ">
				<view v-for="(item,index) in buttonGroup" :key="index"
					...
					<text :class="item.iconClass" style="margin-right: 10rpx;" :style="{color:item.color,fontSize:item.fontSize}" v-if="item.iconClass"></text>
					<text :style="{color:item.color,fontSize:item.fontSize}"
						class="uni-tab__cart-button-right-text">{{ item.text }}</text>
					</view>
			</view>
		</view>
	</view>
