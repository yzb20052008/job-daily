	...
	<view class="uni-cursor-point">
		...
		<view :class="{
		  ...
		  'uni-fab__content--other-platform': !isAndroidNvue
			...
			<uni-icons v-if="!styles.text" class="fab-circle-icon" type="plusempty" :color="styles.iconColor" size="32"
				:class="{'uni-fab__plus--active': isShow && content.length > 0}"></uni-icons>
			<text class="uni-fab-text" :style="{ 'color': styles.iconColor }" v-else>{{styles.text}}</text>
...
<style lang="scss" >
	...
	.uni-fab--rightBottom {
		...
		bottom: calc(110px + var(--window-bottom));
		/* #endif */
		// padding: 10px;
	}
	...
	.uni-fab__circle--rightBottom {
		...
		bottom: 180upx;
		/* #ifdef H5 */
		right: calc(30upx + var(--window-right));
		bottom: calc(180upx + var(--window-bottom));
		/* #endif */
	}
