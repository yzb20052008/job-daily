...
/*	@Override
	...
	public SysUser getUserByThirdId(String thirdId) {
		return userMapper.getUserInfo(new SysUser().setThirdId(thirdId));
	}

	@Override
	public SysUser getUserByTtId(String ttId) {
		return userMapper.getUserInfo(new SysUser().setTtId(ttId));
	}

	@Override
	public SysUser getUserByInviteCode(String inviteCode) {
		return userMapper.selectOne(new QueryWrapper<>(new SysUser().setInviteCode(inviteCode).setDelFlag(0)));
	}
...
//	@Cacheable(cacheNames=CacheConstant.SYS_USERS_CACHE, key="#username")
	...
	@Override
	public IPage<Map<String, Object>> getUserList(Page<SysUser> page, SysUser params) {
		return baseMapper.getUserList(page,params);
	}
