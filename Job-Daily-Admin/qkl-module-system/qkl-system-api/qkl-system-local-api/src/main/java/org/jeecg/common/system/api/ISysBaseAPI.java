...
public interface ISysBaseAPI extends CommonAPI {
     ...
     * @return
     */
    List<Map<String,String>> getRoleMapByUserName(String username);
     ...
     * @return
     */
    List<Map<String,String>> getRoleByPlatform(String platform);
     ...
     * @param username
     */
    Result<?> getUserPermissionByToken(String username);
     ...
     * @return List<String>
     */
    List<SelectTreeModel> loadCategoryList(String pcode);
     ...
     * @param loginUser
     */
    void saveUser(LoginUser loginUser, String selectedRoles, String selectedDeparts, String relTenantIds);
     ...
     * @param loginUser
     */
    void updateUserInfo(LoginUser loginUser, String selectedRoles, String selectedDeparts, String relTenantIds);
     ...
     * @return
     */
    Result<?> checkUserIsEffective(LoginUser loginUser);
     ...
     * @param password 登录密码
     */
    void changePassword(String userId, String username,String password);
}
