    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="数据ID" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="dataId">
              <a-input v-model="model.dataId" placeholder="请输入数据ID"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/job/jobBrowse/add",
          edit: "/job/jobBrowse/edit",
          queryById: "/job/jobBrowse/queryById"
        }
      }
    },
    computed: {
