...
public class IntegralGoodsController extends JeecgController<IntegralGoods, IIntegralGoodsService> {
	...
	public Result<IPage<IntegralGoods>> queryPageList(IntegralGoods integralGoods,
	...
	@RequiresPermissions("integral:integral_goods:add")
	@PostMapping(value = "/add")
	public Result<String> add(@RequestBody IntegralGoods integralGoods) {
	...
	@RequiresPermissions("integral:integral_goods:edit")
	@RequestMapping(value = "/edit", method = {RequestMethod.PUT,RequestMethod.POST})
	public Result<String> edit(@RequestBody IntegralGoods integralGoods) {
	...
	@RequiresPermissions("integral:integral_goods:delete")
	...
	@RequiresPermissions("integral:integral_goods:deleteBatch")
	...
	public Result<IntegralGoods> queryById(@RequestParam(name="id",required=true) String id) {
    ...
    * @param integralGoods
    */
    @RequiresPermissions("integral:integral_goods:exportXls")
    ...
    * @return
    */
    @RequiresPermissions("integral:integral_goods:importExcel")
