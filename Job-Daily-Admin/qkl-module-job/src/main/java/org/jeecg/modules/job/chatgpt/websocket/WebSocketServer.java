package org.jeecg.modules.job.chatgpt.websocket;
...
import org.jeecg.modules.job.chatgpt.listener.OpenAIWebSocketEventSourceListener;
...
public class WebSocketServer {
    ...
    public void onMessage(String msg) {
        try{
    //        webSocketServer.sseService.wssMsg(msg,this.uid,this.session);
    ...
    //        String messageContext = (String) redisUtil.get(uid);
    ...
    //        redisUtil.set(uid, JSONUtil.toJsonStr(messages), 10*24*60*60);
        }catch (Exception e){
            e.printStackTrace();
