...
@ApiModel(value="cms_articles对象", description="文章内容")
public class CmsArticles implements Serializable {
	...
	/**分类编码*/
	@Excel(name = "分类编码", width = 15, dictTable = "cms_category", dicText = "name", dicCode = "id")
	@Dict(dictTable = "cms_category", dicText = "name", dicCode = "id")
