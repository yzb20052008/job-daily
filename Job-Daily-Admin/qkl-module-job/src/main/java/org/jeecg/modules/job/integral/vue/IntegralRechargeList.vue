        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="订单编码">
              <a-input placeholder="请输入订单编码" v-model="queryParam.orderSn"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'BigDecimal',value:'money',text:'充值金额',dictCode:''})
        fieldList.push({type:'BigDecimal',value:'integral',text:'充值积分',dictCode:''})
        fieldList.push({type:'string',value:'payType',text:'充值方式',dictCode:''})
        fieldList.push({type:'string',value:'rechargeStatus',text:'充值状态',dictCode:''})
