    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="图片信息" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="imgs">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/job/jobOrderLog/add",
          edit: "/job/jobOrderLog/edit",
          queryById: "/job/jobOrderLog/queryById"
        }
      }
    },
    computed: {
