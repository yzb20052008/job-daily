    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        <a-form-model-item label="分类编码" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="code">
          <a-input v-model="model.code" placeholder="请输入分类编码" ></a-input>
        </a-form-model-item>
        ...
        <a-form-model-item label="类别描述" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="description">
          <a-textarea v-model="model.description" rows="4" placeholder="请输入类别描述" />
        </a-form-model-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/cms/cmsCategory/add",
          edit: "/cms/cmsCategory/edit",
        },
        expandedRowKeys:[],
        pidField:"pid"
