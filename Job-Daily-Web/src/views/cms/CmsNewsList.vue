<template>
  <a-card :bordered="false">
    ...
    <cms-news-modal ref="modalForm" @ok="modalFormOk"></cms-news-modal>
  </a-card>
</template>
...
<script>
  ...
  import CmsNewsModal from './modules/CmsNewsModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/cms/cmsNews/list",
          delete: "/cms/cmsNews/delete",
          deleteBatch: "/cms/cmsNews/deleteBatch",
          exportXlsUrl: "/cms/cmsNews/exportXls",
          importExcelUrl: "cms/cmsNews/importExcel",
