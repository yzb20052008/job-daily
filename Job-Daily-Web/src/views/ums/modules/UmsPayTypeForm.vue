    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <!-- <a-col :span="24">
            <a-form-model-item label="应用模块" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="appModule">
              <j-dict-select-tag type="list" v-model="model.appModule" dictCode="app_module" placeholder="请选择应用模块" />
            </a-form-model-item>
          </a-col> -->
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/ums/umsPayType/add",
          edit: "/ums/umsPayType/edit",
          queryById: "/ums/umsPayType/queryById"
        }
      }
    },
    computed: {
