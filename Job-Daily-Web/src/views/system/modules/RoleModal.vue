  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form"  v-bind="layout"  :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="所属平台" required prop="roleName">
          <j-dict-select-tag type="list" v-model="model.platform" dictCode="platform" placeholder="请选择所属平台" />
        </a-form-model-item>
        <a-form-model-item label="描述" prop="description">
          <a-textarea :rows="5" v-model="model.description" placeholder="请输入角色描述"/>
        </a-form-model-item>
        <a-form-model-item label="排序" required prop="roleName">
          <a-input-number v-model="model.sort" placeholder="请输入排序"/>
        </a-form-model-item>
        <a-form-model-item label="启用状态" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="status">
          <j-dict-select-tag type="radio" v-model="model.status" dictCode="role_status" placeholder="请选择启用状态" />
        </a-form-model-item>
      </a-form-model>
    </a-spin>
  </a-modal>
